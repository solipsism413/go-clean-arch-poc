...
func (r *Router) registerRoutes() {
	...
	r.mux.HandleFunc("POST /api/v1/tasks/{id}/attachments", r.withAuth(r.taskHandler.UploadAttachment))
	r.mux.HandleFunc("GET /api/v1/tasks/{id}/attachments", r.withAuth(r.taskHandler.ListAttachments))
	r.mux.HandleFunc("GET /api/v1/tasks/{id}/attachments/{attachmentId}", r.withAuth(r.taskHandler.DownloadAttachment))
	r.mux.HandleFunc("DELETE /api/v1/tasks/{id}/attachments/{attachmentId}", r.withAuth(r.taskHandler.DeleteAttachment))
