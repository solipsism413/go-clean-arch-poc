...
The main delivery gaps are transport parity and feature completion around self-registration, label management, file attachments, GraphQL exposure, and gRPC service registration.
